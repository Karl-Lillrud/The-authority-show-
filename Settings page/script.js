...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function addGuestRow(name = "", email = "", social = "", date = "") {
    ...
    row.innerHTML = `
      ...
      <td><button class="status-toggle" data-status="incomplete">🔴</button></td>
    `;
  }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  addEpisodeButton.addEventListener("click", function () {
    ...
    newEpisode.innerHTML = `
      ...
      <span class="remove-episode" data-target="task-${episodeCount}" style="display: none;">❌</span>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // -------------------------------
  // Payment Method Functionality Using a Drop‑Down
  // -------------------------------
  let paymentMethods = []; // Global array to store payment methods
  
  // Update the drop‑down with the current payment methods
  ...
  // -------------------------------
  // Subscription Modal with Payment Methods Drop‑Down
  // -------------------------------
  ...
  // Payment Method buttons event listeners using the drop‑down

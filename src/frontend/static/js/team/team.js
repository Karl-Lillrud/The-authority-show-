...
function updateTeamsUI(teams) {
  ...
  teams.forEach((team) => {
    ...
    card.innerHTML = `
      ...
      <div class="team-card-body">
        ...
        <div class="member-chips">
          ${team.members.map((m) => `<span class="member-chip">${m.email}</span>`).join("")}
        </div>
      </div>
    ...
    `
    card.querySelector(".edit-team-btn").addEventListener("click", () => showTeamDetailModal(team))
    card.querySelector(".delete-team-btn").addEventListener("click", async () => {
      try {
...
function showTeamDetailModal(team) {
  ...
  team.members.forEach((member) => {
    ...
    const memberRows = document.querySelectorAll("#members-container-edit .member-row")
  ...
  saveBtn.onclick = async () => {
    ...
    document.querySelectorAll("#members-container-edit .member-row").forEach((row) => {

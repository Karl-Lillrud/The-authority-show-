...
const svgStore = {
  ...
  styleMinimalIcon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>`,

  stylePremiumIcon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/><circle cx="12" cy="12" r="3"/></svg>`,

  styleEnterpriseIcon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20h20"/><path d="M5 20V7a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v13"/><path d="M13 20V4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v16"/></svg>`,
  ...
  cartToggleIcon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m19 12-7-7-7 7"/></svg>`,

  cartExpandIcon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m5 12 7 7 7-7"/></svg>`,
...
function initSvgIcons() {
  ...
  document.querySelector(".credit-small-icon").innerHTML =
    svgStore.creditSmallIcon;
  document.querySelector(".credit-medium-icon").innerHTML =
    svgStore.creditMediumIcon;
  document.querySelector(".credit-large-icon").innerHTML =
    svgStore.creditLargeIcon;

  // Style icons
  document.querySelector(".style-minimal-icon").innerHTML =
    svgStore.styleMinimalIcon;
  document.querySelector(".style-premium-icon").innerHTML =
    svgStore.stylePremiumIcon;
  document.querySelector(".style-enterprise-icon").innerHTML =
    svgStore.styleEnterpriseIcon;

  // Subscription icons
  document.querySelector(".subscription-pro-icon").innerHTML =
    svgStore.subscriptionProIcon;
  document.querySelector(".subscription-team-icon").innerHTML =
  ...
  if (episodeIcon) {
    episodeIcon.innerHTML = svgStore.episodeIcon;
  }

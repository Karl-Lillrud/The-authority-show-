...
from backend.routes.recording_studio import recording_studio_bp  # Add this import
...
app.register_blueprint(recording_studio_bp)  # Add this line after the other blueprint registrations
